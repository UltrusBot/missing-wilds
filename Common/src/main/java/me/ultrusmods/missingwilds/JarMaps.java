...
public class JarMaps {
    ...
    static {
        ...
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.JAR_BLOCK.get(), MissingWildsBlocks.FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.TINTED_JAR_BLOCK.get(), MissingWildsBlocks.TINTED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.WHITE_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.WHITE_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.ORANGE_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.ORANGE_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.MAGENTA_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.MAGENTA_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.LIGHT_BLUE_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.LIGHT_BLUE_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.YELLOW_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.YELLOW_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.LIME_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.LIME_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.PINK_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.PINK_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.GRAY_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.GRAY_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.LIGHT_GRAY_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.LIGHT_GRAY_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.CYAN_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.CYAN_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.PURPLE_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.PURPLE_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.BLUE_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.BLUE_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.BROWN_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.BROWN_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.GREEN_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.GREEN_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.RED_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.RED_STAINED_FOOD_JAR_BLOCK.get());
        JAR_TO_FOOD_JAR.put(MissingWildsBlocks.BLACK_STAINED_JAR_BLOCK.get(), MissingWildsBlocks.BLACK_STAINED_FOOD_JAR_BLOCK.get());
