...
public class MissingWildsModelTemplates {
    ...
    public static final ModelTemplate FALLEN_LOG_MOSSY = create("template/fallen_log_template_mossy", LOG, LOG_INNER);
    public static final ModelTemplate FALLEN_LOG_SNOWY = create("template/fallen_log_template_snowy", LOG, LOG_INNER);
